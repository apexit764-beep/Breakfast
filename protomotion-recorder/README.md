...
**في مقايضة ما إلها حل:** ما بتقدر تجمع بين دقة عالية وضغط يدوي، لأن شاشتك
طولها ~1050 بكسل وما بتسع شباك طوله 2556. فإما:

| بدك | الأمر |
|---|---|
| تضغط بنفسك | `-s 1 --manual --cursor` (فيديو 393×852) |
| أعلى دقة | `-s 3` بدون `--manual` (فيديو 1179×2556، ضغط تلقائي) |

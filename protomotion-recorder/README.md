...
```
node record.js -u "الرابط" -w 393 -h 852 -s 1 --manual --cursor --nodetect --save-clicks clicks.json
```

شباك 393×852 مريح، بتشوف المؤشر وبتضغط على أي زر. لما تخلص اضغط Enter.
